...
// Imports: Init DimensionalAnalysis.Basic
#include <lean/lean.h>
...
x_6 = l_dimension_pow___at_dimension_area___spec__2___rarg(x_3, x_5, x_2);
lean_dec(x_5);
return x_6;
}
}
...
x_7 = l_dimension_div___at_dimension_acceleration___spec__2___rarg(x_4, x_6, x_3);
return x_7;
}
}
...
x_5 = lean_alloc_closure((void*)(l_dimension_volume___rarg), 2, 1);
...
x_7 = lean_alloc_closure((void*)(l_dimension_time___rarg), 2, 1);
...
lean_inc(x_2);
lean_inc(x_1);
x_6 = lean_alloc_closure((void*)(l_dimension_velocity___rarg), 3, 2);
lean_closure_set(x_6, 0, x_1);
...
lean_inc(x_1);
x_8 = lean_alloc_closure((void*)(l_dimension_length___rarg), 2, 1);
...
lean_object* initialize_DimensionalAnalysis_Basic(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_DimensionalAnalysis_Basic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
